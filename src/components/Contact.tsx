            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">vivek.sharma@example.com</p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-portfolio-navy text-white p-2 rounded-full hover:bg-portfolio-orange transition-colors">
